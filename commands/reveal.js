...
module.exports = {
	name: 'reveal',
	description: 'reveal a hidden channel to a role or member',
	aliases: [],
	usage: ';reveal [#channel] @role/@member',
	category: "moderation",
	guildOnly: false,
	args: false,
	...
	execute: async (message, args, client) => {
		...
		await channel.permissionOverwrites.edit(targetId, { ViewChannel: true }).catch(() => {});
		message.reply({ embeds: [new EmbedBuilder().setDescription(`${checked} Revealed ${channel} to ${target ? target : 'everyone'}`).setColor(color)] });
	},
};
