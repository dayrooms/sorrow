  ...
  category: "utility",
	...
	execute: async(message, args, client) => {
      ...
      .setColor(color)
        ...
        {
            name:`Members`,
            value: `👥 ${invite.guild.memberCount ||invite.memberCount || `couldn't cache`}`,
            inline: true,
        },
        {
            name:`Security`,
            value: `🛡️  ${verificationLevels[invite.guild.verificationLevel]}`,
            inline:true,
        },
        {
            name:`Server Owner`,
            value: `👑  ${owner  || `couldn't cache`}`,
            inline:true,
        },
        {
            name:`Server Created At`,
            value:`🕒  ${invite.guild.createdAt.toDateString()}`,
            inline: true,
        },
        {
            name:`Booster Count`,
